        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_Discount_Valid", "[DiscountPercentage] >= 0 AND [DiscountPercentage] <= 0.15");
                    table.CheckConstraint("CK_Products_Price_Positive", "[Price] > 0");
                    table.CheckConstraint("CK_Products_Quantity_NonNegative", "[QuantityInStock] >= 0");
                    table.ForeignKey(
